...
import 'core/services/db/entity.dart';

export 'package:objectbox/objectbox.dart'; // so that callers only have to import this file

final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 865847058001365950),
      name: 'Person',
      lastPropertyId: const obx_int.IdUid(4, 6492682671764960190),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 2218095645628015060),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 5999042565106553395),
            name: 'name',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 825920055455310281),
            name: 'age',
            type: 6,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(4, 6492682671764960190),
            name: 'personId',
            type: 9,
            flags: 0)
      ],
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(1, 865847058001365950),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    Person: obx_int.EntityDefinition<Person>(
        ...
        objectToFB: (Person object, fb.Builder fbb) {
          ...
          fbb.addOffset(3, personIdOffset);
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final object = Person(
              personId: personIdParam, name: nameParam, age: ageParam)
